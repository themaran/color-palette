...
const App = () => {
  ...
  return (
    <div className="flex flex-col h-screen relative">
      ...
      <button className='absolute transform bottom-72 p-4 rounded-full mx-auto right-0 mr-2 mb-2  bg-white shadow-lg md:hidden' onClick={generateNewColourPalette}>
